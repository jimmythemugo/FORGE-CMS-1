...
- Added columns to orders table for delivery

3. Security
- RLS enabled on all new tables
- Public read where appropriate, anon write (single-tenant, no auth)
*/
...
-- RLS Policies - Public read, anon write (single-tenant, no auth)
